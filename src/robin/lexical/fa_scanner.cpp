...
namespace rbn::lexical
{
  ...
  core::Token FAScanner::get_token()
  {
    str = "";
    int state = 0;
    token_start = curr;
    ...
    while (state >= START_STATE && state <= END_STATE)
    {
      ...
      case 14:
        ...
        break;
      case 15:
        return create_token("==", core::TokenType::IS_EQUAL_OP);

      case 16:
        return create_token("=", core::TokenType::EQUAL_OP);
      ...
      case 17:
        ...
        break;
      case 18:
        return create_token("+", core::TokenType::PLUS_OP);

      case 19:
        return create_token("++", core::TokenType::INCREMENT_OP);
      ...
      case 20:
        ...
        break;
      case 21:
        return create_token("--", core::TokenType::DECREMENT_OP);

      case 22:
        return create_token("-", core::TokenType::MINUS_OP);
      ...
      case 23:
        ...
        break;
      case 24:
        return create_token("<", core::TokenType::LESS_THAN_OP);

      case 25:
        return create_token("<=", core::TokenType::LESS_EQUAL_OP);

      case 26:
        return create_token("<>", core::TokenType::NOT_EQUAL_OP);
      ...
      case 27:
        ...
        break;
      case 28:
        return create_token(">", core::TokenType::GREATER_THAN_OP);

      case 29:
        return create_token(">=", core::TokenType::GREATER_EQUAL_OP);
      ...
      case 30:
        ...
        break;
      case 31:
        return create_token("/", core::TokenType::DIVIDE_OP);
  ...
  vector<core::Token> FAScanner::get_tokens_stream(void)
  {
